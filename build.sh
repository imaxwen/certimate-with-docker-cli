...
IMAGE_REPO=registry.cn-shanghai.aliyuncs.com
IMAGE_NAME_VERSIONED=$IMAGE_REPO/maxwen/certimate-docker:${VERSION}
IMAGE_NAME_LATEST=$IMAGE_REPO/maxwen/certimate-docker:latest
...
echo "Enter docker registry login password:"

# login to docker registry
docker login $IMAGE_REPO --username=maxwen
...
echo -e "Successfully built and pushed Docker image: \n ${IMAGE_NAME_VERSIONED}\n ${IMAGE_NAME_LATEST}"
